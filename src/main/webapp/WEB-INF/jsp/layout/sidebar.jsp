<%@ page contentType="text/html; charset=UTF-8" %>
  <%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
      <aside class="sticky top-20 h-full  xl:w-72 hidden xl:block bg-light bg-white self-start mt-22 ">
                                    <div class="max-h-full overflow-hidden flex-grow">
                                        <div class="os-host os-host-foreign os-theme-thin-dark w-full max-h-screen os-host-resize-disabled os-host-scrollbar-horizontal-hidden os-host-scrollbar-vertical-hidden os-host-transition"
                                                    ...
                                                    <div class="os-content" style="padding: 0px; height: 100%; width: 100%; float: left;">
                                                        <div class="px-5">
                                                            <ul class="text-xs xl:py-8">
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-accent text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.347 24.101"
                                                                                ...
                                                                                <g id="Grocery" transform="translate(-39.481 0.052)">
                                                                                    ...
                                                                                    <path id="Path_17387" data-name="Path 17387"
                                                                                        ...
                                                                                        transform="translate(-0.5)" fill="currentColor"
                                                                                        stroke="currentColor" stroke-width="0.1"></path>
                                                                                </g>
                                                                            </svg></span><span>Fruits &amp; Vegetables</span><span
                                                                            class="ltr:ml-auto rtl:mr-auto"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M5 15l7-7 7 7"></path>
                                                                            </svg></span></button></li>
                                                                <li>
                                                                    <ul class="ltr:ml-4 rtl:mr-4 text-xs" style="opacity: 1; height: auto;">
                                                                        <li class="py-1 rounded-md" style="background-color: rgb(255, 255, 255);">
                                                                            <button
                                                                                class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm text-body ltr:ml-5 rtl:mr-5"><span>Fruits</span><span
                                                                                    class="ltr:ml-auto rtl:mr-auto"></span></button></li>
                                                                        <li class="py-1 rounded-md" style="background-color: rgb(255, 255, 255);">
                                                                            <button
                                                                                class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm text-body ltr:ml-5 rtl:mr-5"><span>Vegetables</span><span
                                                                                    class="ltr:ml-auto rtl:mr-auto"></span></button></li>
                                                                    </ul>
                                                                </li>
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.003 24"
                                                                                fill="currentColor" class="h-full w-full">
                                                                                <g id="Meat_Fish" data-name="Meat &amp; Fish"
                                                                                    ...
                                                                                    <path id="Path_17433" data-name="Path 17433"
                                                                                        ...
                                                                                        transform="translate(-42.009 -2.453)" fill="currentColor">
                                                                                    </path>
                                                                                    ...
                                                                                    <path id="Path_17436" data-name="Path 17436"
                                                                                        ...
                                                                                        transform="translate(-95.146 -11.027)" fill="currentColor">
                                                                                    </path>
                                                                                    <path id="Path_17437" data-name="Path 17437"
                                                                                        ...
                                                                                        transform="translate(-70.129 -35.084)" fill="currentColor">
                                                                                    </path>
                                                                                    <path id="Path_17438" data-name="Path 17438"
                                                                                        ...
                                                                                        transform="translate(-56.046 -50.535)" fill="currentColor">
                                                                                    </path>
                                                                                    <path id="Path_17439" data-name="Path 17439"
                                                                                        ...
                                                                                        transform="translate(-121.487 -37.372)" fill="currentColor">
                                                                                    </path>
                                                                                </g>
                                                                            </svg></span><span>Meat &amp; Fish</span><span
                                                                            class="ltr:ml-auto rtl:mr-auto"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="25.143" height="22"
                                                                                viewBox="0 0 25.143 22" fill="currentColor" class="h-full w-full">
                                                                                    ...
                                                                                    <g id="Group_5716" data-name="Group 5716"
                                                                                        ...
                                                                                        <g id="Group_5715" data-name="Group 5715"
                                                                                            ...
                                                                                            <path id="Path_17399" data-name="Path 17399"
                                                                                                ...
                                                                                                transform="translate(0 -415.966)" fill="currentColor">
                                                                                            </path>
                                                                                        </g>
                                                                                    </g>
                                                                            ...
                                                                            </svg></span><span>Snacks</span><span class="ltr:ml-auto rtl:mr-auto"><svg
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="60"
                                                                                height="60" fill="currentColor" class="h-full w-full">
                                                                                <g id="Outline">
                                                                                    <path
                                                                            ...
                                                                            </svg></span><span>Pet Care</span><span class="ltr:ml-auto rtl:mr-auto"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20.59 25.05"
                                                                                fill="currentColor" class="h-full w-full">
                                                                                <g id="home_cleaner" data-name="home cleaner"
                                                                                    ...
                                                                                    <path id="Path_17440" data-name="Path 17440"
                                                                                        ...
                                                                                        transform="translate(-39.669 -37.554)" fill="none"
                                                                                    ...
                                                                                    <path id="Path_17441" data-name="Path 17441"
                                                                                        ...
                                                                                        transform="translate(-138.167 -70.32)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></path>
                                                                                    ...
                                                                                    <path id="Path_17445" data-name="Path 17445"
                                                                                        ...
                                                                                        transform="translate(0 -129.588)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></path>
                                                                                    <path id="Path_17446" data-name="Path 17446"
                                                                                        ...
                                                                                        transform="translate(-129.259 -130.762)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></path>
                                                                                    <line id="Line_15" data-name="Line 15" y1="1.511" x2="3.16"
                                                                                        transform="translate(2154.628 788.235)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></line>
                                                                                    <line id="Line_16" data-name="Line 16" x2="3.16" y2="1.511"
                                                                                        transform="translate(2154.628 792.632)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></line>
                                                                                    <line id="Line_17" data-name="Line 17" x2="4.259"
                                                                                        transform="translate(2154.628 791.189)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></line>
                                                                                    <circle id="Ellipse_9" data-name="Ellipse 9" cx="2.047" cy="2.047"
                                                                                        r="2.047" transform="translate(2158.239 799.709)"
                                                                                        stroke-width="0.9" stroke="currentColor" stroke-linecap="round"
                                                                                    ...
                                                                                    <path id="Path_17447" data-name="Path 17447"
                                                                                        ...
                                                                                        transform="translate(-228.757 -159.112)" fill="none"
                                                                                        stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" stroke-width="0.9"></path>
                                                                                    <circle id="Ellipse_10" data-name="Ellipse 10" cx="2.764" cy="2.764"
                                                                                        r="2.764" transform="translate(2152.212 802.109)"
                                                                                        stroke-width="0.9" stroke="currentColor" stroke-linecap="round"
                                                                                        stroke-linejoin="round" fill="none"></circle>
                                                                                </g>
                                                                            </svg></span><span>Home &amp; Cleaning</span><span
                                                                            class="ltr:ml-auto rtl:mr-auto"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.967 22.1"
                                                                                fill="currentColor" class="h-full w-full">
                                                                            ...
                                                                            </svg></span><span>Dairy</span><span class="ltr:ml-auto rtl:mr-auto"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.9 16.9"
                                                                                fill="currentColor" class="h-full w-full">
                                                                                <g id="Cooking" transform="translate(-61.55 -195.55)">
                                                                                    <g id="Group_12320" data-name="Group 12320"
                                                                                        ...
                                                                                        <path id="Path_17430" data-name="Path 17430"
                                                                                            ...
                                                                                            transform="translate(-509.882 -399.805)" fill="none"
                                                                                            stroke="currentColor" stroke-linejoin="round"
                                                                                            stroke-width="0.9"></path>
                                                                                        <line id="Line_13" data-name="Line 13" y1="1.939"
                                                                                            transform="translate(13.941)" fill="none"
                                                                                            stroke="currentColor" stroke-miterlimit="10"
                                                                                            stroke-width="0.9"></line>
                                                                                        <line id="Line_14" data-name="Line 14" x2="3.606"
                                                                                            transform="translate(12.197)" fill="none"
                                                                                            stroke="currentColor" stroke-miterlimit="10"
                                                                                            stroke-width="0.9"></line>
                                                                                        <path id="Path_17431" data-name="Path 17431"
                                                                                            ...
                                                                                            transform="translate(-509.882 -406.911)" fill="none"
                                                                                            stroke="currentColor" stroke-linejoin="round"
                                                                                            stroke-width="0.9"></path>
                                                                                    </g>
                                                                                </g>
                                                                            </svg></span><span>Cooking</span><span class="ltr:ml-auto rtl:mr-auto"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25.408 18.5"
                                                                                fill="currentColor" class="h-full w-full">
                                                                                <g id="Breakfast" transform="translate(0.25 -70.75)">
                                                                                    <path id="Path_17388" data-name="Path 17388"
                                                                                        ...
                                                                                        transform="translate(-229.276 -57.081)" fill="currentColor"
                                                                                    ...
                                                                                    <path id="Path_17389" data-name="Path 17389"
                                                                                        ...
                                                                                        transform="translate(-276.841 -57.08)" fill="currentColor"
                                                                                        stroke="#fff" stroke-width="0.4"></path>
                                                                                    <path id="Path_17390" data-name="Path 17390"
                                                                                        ...
                                                                                        transform="translate(-162.679 -57.08)" fill="currentColor"
                                                                                        stroke="#fff" stroke-width="0.4"></path>
                                                                                    <path id="Path_17391" data-name="Path 17391"
                                                                                        ...
                                                                                        transform="translate(0 0)" fill="currentColor" stroke="#fff"
                                                                                        stroke-width="0.5"></path>
                                                                                </g>
                                                                            </svg></span><span>Breakfast</span><span
                                                                            class="ltr:ml-auto rtl:mr-auto"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14.569 26.099"
                                                                                class="h-full w-full">
                                                                                <path id="bevarage"
                                                                                    ...
                                                                                    transform="translate(-895.457 -373.443)" fill="currentColor"
                                                                                    stroke="#fff" stroke-width="0.1"></path>
                                                                            </svg></span><span>Beverage</span><span class="ltr:ml-auto rtl:mr-auto"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                                                stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
                                                                ...
                                                                <li class="py-1 rounded-md" style="background-color:#ffffff"><button
                                                                        class="flex items-center w-full py-2 ltr:text-left rtl:text-right outline-none text-body-dark font-semibold  focus:outline-none focus:ring-0 focus:text-accent transition-all ease-in-expo text-body-dark text-sm"><span
                                                                            class="flex w-5 h-5 ltr:mr-4 rtl:ml-4 items-center justify-center"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17.112 24"
                                                                                fill="currentColor" class="h-full w-full">
                                                                                <g id="Beauty" transform="translate(-1278.138 -490.139)">
                                                                                    ...
                                                                                    <path id="Path_17449" data-name="Path 17449"
                                                                                        ...
                                                                                        transform="translate(-50.749 -34.18)" fill="currentColor">
                                                                                    </path>
                                                                                    <path id="Path_17450" data-name="Path 17450"
                                                                                        ...
                                                                                        transform="translate(-101.725 -37.618)" fill="currentColor">
                                                                                    </path>
                                                                                    <path id="Path_17451" data-name="Path 17451"
                                                                                        ...
                                                                                        transform="translate(-54.184 -52.089)" fill="currentColor">
                                                                                    </path>
                                                                                </g>
                                                                            </svg></span><span>Health &amp; Beauty</span><span
                                                                            class="ltr:ml-auto rtl:mr-auto"><svg xmlns="http://www.w3.org/2000/svg"
                                                                                fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-3 h-3">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                                                    d="M19 9l-7 7-7-7"></path>
